...
def load_background():
    try:
        with open("saves/currentBG.txt", "r") as file:
...
while True:
    ...
    draw_text("Start", font, BLACK, screen, 65, 65)
    draw_text("Shop", font, BLACK, screen, 65, 165)
    draw_text("Exit", font, BLACK, screen, 65, 265)
