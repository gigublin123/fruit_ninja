...
def run_game():
    ...
    watermelon_image = pygame.transform.scale(watermelon_image, (45, 45))

    bomb_image = pygame.image.load("bomb.png")
    bomb_image = pygame.transform.scale(bomb_image, (45, 45))

    explode_image = pygame.image.load("'explode.png")
    explode_image = pygame.transform.scale(explode_image, (45, 45))
    ...
    spot_orange_image = pygame.image.load("spot_orange.png")
    ...
    spot_watermelon_image = pygame.transform.scale(spot_watermelon_image, (45, 45))
